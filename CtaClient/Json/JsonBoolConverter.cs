...
internal class JsonBoolConverter : JsonConverter<bool>
{
    ...
    reader.TokenType switch
    {
        ...
        _ => throw new JsonException($"[JsonBoolConverter] Received JSON type {reader.TokenType} that could not be read as boolean"),
    };
    ...
    /// </summary>
    private static bool TryParseString(Utf8JsonReader reader)
    {
